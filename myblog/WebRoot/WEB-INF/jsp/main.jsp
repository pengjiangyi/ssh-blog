		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse"
				...
				<ul class="nav navbar-nav">
					...
					<li class="head-li" id="ht5"><a href="${pageContext.request.contextPath}/photo.html">摄影</a></li>
				</ul>
					...
					<c:forEach items="${map.list}" var="list">
						<div id="article-list">
							...
							<div class="article"
								...
								<span onclick="readAll(${list.id})" class="title"
									style="font-size: 20px; display: inline-block;margin-left: 10px; font:bold 20px/1.5em "MicrosoftYaHei";" >${list.title}</span>
								...
								<div class="text"
									...
									<div style="float: left;width: 200px;height: 200px">
										<img alt="" src="${list.imgPath}" style="width: 200px"
											height="200px">
									</div>
									<div
								...
								<div
									...
									<button class="btn btn-default" type="button"
										onclick="readAll(${list.id})">阅读全文</button>
								</div>
