...
<a class="navbar-brand" href="#" style="margin-left:5%;"><img src="${pageContext.request.contextPath}/images/logo4.png" alt="logo" style="margin-top:-5px ;"></a>			</div>
...
<div class="container" style="margin-top: 50px;">
	...
	<div style="display: none" id="pagecount">
		...
		${map.page}
			...
			<div style="display: none" id="tagsname">
		${tagsname}
		</div>
	...
	<script type="text/javascript" src="js/tags-article.js">
