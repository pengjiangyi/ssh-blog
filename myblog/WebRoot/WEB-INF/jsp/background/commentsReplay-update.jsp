...
<html>
  ...
  <td>回复内容:</td>
  <td>
  <input type="text" name="name" id="name" value="${text}">
  <input type="hidden"  value="${id}" id="wordsid"> 
  </td>
  </tr>
  <tr>
  <td></td>
  <td><input id="btn" onclick="update()"  type="button" value="提交" style="float: right;"></td>
  </tr>
  </table>
...
var rootPath = getRootPath();
	...
	$.ajax({
				url : rootPath+"/updateCommentsReplyById.ajax",
				type : "post",
				data : {
				text:text,
				ID:id
